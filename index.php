...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/bps.png">
    <title>Login Inventaris BPS Marabahan</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="login-register">        
            ...
            <div class="card-body">
                <form action="_config/cek_login.php" method="post" class="form-horizontal form-material" id="loginform">
                    ...
                    <h3 class="box-title m-b-20"><b>Silahkan Login<b></h3>
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button name="log" type="submit" class="btn btn-primary btn-info waves-effect w-md waves-light m-b-5" type="submit">Log In</button>
                            <button type="reset" class="btn btn-primary btn-inverse waves-effect w-md waves-light m-b-5" name="reset">Batal</button>
                        </div>
                    </div>
                </form>
            </div>
