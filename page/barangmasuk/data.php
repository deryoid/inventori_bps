            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><b>Data Material Masuk</b></h4>
                                <br>
                                ...
                                <a href="print.php" class="btn btn-default waves-effect m-b-5" data-toggle="modal" data-target="#print_tgl" title="Print Data"><i class="mdi mdi-timetable" aria-hidden="true"></i> Data Barang Masuk Pertanggal</a>
                                <div class="table-responsive m-t-40">
                                    <table id="materialmasuk" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>No.Transaksi</th>
                                                <th>Tanggal Masuk</th>
                                        ...
                                        <tbody>
                                        <?php
                                            $query = mysqli_query ($con, "SELECT * FROM tb_barang_masuk");
                    ...
                    <!-- End PAge Content -->
                    <!-- ============================================================== -->
                                 <form action="prinktgl.php" method="POST" target="blank">
