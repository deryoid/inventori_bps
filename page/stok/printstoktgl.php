...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData () {
        ...
        if (isset($_POST['cetak'])) {
          $sql = mysqli_query($con, "SELECT * FROM tb_stok WHERE (tgl_masuk BETWEEN '$tglmulai' AND '$tglselesai') ORDER BY tgl_masuk ASC");
        ...
        $this->SetFont("", "B", 14);
        $this->SetX($left); $this->Cell(0, 20, 'LAPORAN DATA STOK MATERIAL PADA', 0, 1,'C');
        ...
        $this->SetFont("", "B", 10);
        $this->Cell(50,$h,'No.',1,0,'C',true);
        $this->SetX($left += 50); $this->Cell(150, $h, 'Kode Barang.', 1, 0, 'C',true);
        $this->SetX($left += 150); $this->Cell(210, $h, 'Nama Material', 1, 0, 'C',true);
        $this->SetX($left += 210); $this->Cell(200, $h, 'Jenis Material', 1, 0, 'C',true);
        $this->SetX($left += 200); $this->Cell(150, $h, 'Stok', 1, 0, 'C',true);
        $this->SetX($left += 150); $this->Cell(170, $h, 'Tanggal Masuk', 1, 0, 'C',true);
        $this->Ln(18);
        $this->SetFont('Arial','',10);
        $this->SetWidths(array(50,150,210,200,150,170));
        ...
        $this->Ln(50);
        $this->SetX(750); $this->Cell(0, 20, 'Pimpinan', 0, 1,'C');
    } 
