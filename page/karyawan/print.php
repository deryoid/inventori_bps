...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData () {
        ...
        $sql = mysqli_query($con, "SELECT * FROM tb_suplier");
        ...
        $this->SetFont("", "B", 14);
        $this->SetX($left); $this->Cell(0, 20, 'LAPORAN DATA SUPLIER', 0, 1,'C');
        $this->SetFont("", "", 9);
        $this->Ln(10);
        ...
        $this->SetX($left += 40); $this->Cell(85, $h, 'Kode Suplier.', 1, 0, 'C',true);
        $this->SetX($left += 85); $this->Cell(140, $h, 'Nama Suplier', 1, 0, 'C',true);
        $this->SetX($left += 140); $this->Cell(170, $h, 'Telp', 1, 0, 'C',true);
